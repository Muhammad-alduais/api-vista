...
export function registerRoutes(app: any) {
  ...
  // Environments routes
  app.get('/api/providers/:providerId/environments', getEnvironments);
  app.post('/api/environments', createEnvironment);
  app.put('/api/environments/:id', updateEnvironment);
  app.delete('/api/environments/:id', deleteEnvironment);

  // Services routes
  app.get('/api/providers/:providerId/services', getServices);
  ...
  app.get('/api/apis/:id', getApi);
  app.post('/api/apis', createApi);
  app.put('/api/apis/:id', updateApi);
  app.delete('/api/apis/:id', deleteApi);

  // Endpoints routes
  app.get('/api/apis/:apiId/endpoints', getEndpoints);
  app.post('/api/endpoints', createEndpoint);
  app.put('/api/endpoints/:id', updateEndpoint);
  app.delete('/api/endpoints/:id', deleteEndpoint);

  // Operations routes
  app.get('/api/endpoints/:endpointId/operations', getOperations);
  app.get('/api/operations/:id', getOperation);
  app.post('/api/operations', createOperation);
  app.put('/api/operations/:id', updateOperation);
  app.delete('/api/operations/:id', deleteOperation);

  // Parameters routes
  app.get('/api/operations/:operationId/parameters', getParameters);
  app.post('/api/parameters', createParameter);
  app.put('/api/parameters/:id', updateParameter);
  app.delete('/api/parameters/:id', deleteParameter);

  // Response Schemas routes
  app.get('/api/operations/:operationId/response-schemas', getResponseSchemas);
  app.post('/api/response-schemas', createResponseSchema);
  app.put('/api/response-schemas/:id', updateResponseSchema);
  app.delete('/api/response-schemas/:id', deleteResponseSchema);
